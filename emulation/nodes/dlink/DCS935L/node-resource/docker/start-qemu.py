...
# Assign variables
architecture = "mips"  # Example value, modify as needed
...
port_fwds = ["8080:80", "8089:8088", "8443:443","62721:62720","62977:62976","2222:22"] # Example array of port forwarding rules
console = "ttyS0"         # Example value, adjust as needed
root_dev = "/dev/sda1"    # Example value, adjust as needed
log_file_path = "/tmp/execv.log" # Define the log file path
mac = gen_mac()
