...
# Assign variables
architecture = "arm"  # Example value, modify as needed
memsize = "256"       # Example value, adjust as needed
board = "versatilepb"  # Example value, adjust as needed
kernel = "kernel"      # Example file name, change as needed
image = "image.qcow2"  # Example file name, change as needed
initrd = "initrd"      # Example file name, change as needed or set to None
port_fwds = ["8080:80", "2222:22", "50629:50628","555:554","3703:3702","40629:40268"]  # Example array of port forwarding rules
console = "ttyAMA0"   # Example value, adjust as needed
